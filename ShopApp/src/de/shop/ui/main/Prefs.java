...
public class Prefs extends PreferenceFragment implements
	...
	public static void init(Context ctx) {
		...
		// /data/data/de.shop/shared_prefs/de.shop_preferences.xml
		// repraesentiert
		...
		Log.i(LOG_TAG, "protocol=" + protocol + ", host=" + host + ", port="
				+ port + ", path=" + path + ", timeoutStr=" + timeoutStr
