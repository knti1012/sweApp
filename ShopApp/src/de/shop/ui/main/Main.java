...
public class Main extends Activity implements OnClickListener {
	...
	public void onClick(View view) {
		...
		final EditText kundeNameTxt = (EditText) findViewById(R.id.kunde_name);
		final String kundeName = kundeNameTxt.getText().toString();
		
		final Kunde kunde = getKunde(kundeId, kundeName);
    ...
    private Kunde getKunde(String kundeIdStr, String kundeName) {
    	final Long kundeId = Long.valueOf(kundeIdStr);
    	final Kunde kunde = new Kunde(kundeId, kundeName);
